...
<thead className="text-white uppercase bg-[#2f3e46]">
  <tr>
    <th className="px-4">Habitación</th>     {/* Room */}
    <th className="px-4">Estado</th>         {/* Status */}
    <th className="px-4">Disponibilidad</th> {/* Disponibilité */}
  </tr>
</thead>
...
<td className="px-4 sm:px-6 py-3 border-r border-gray-200">
  <div className="flex flex-col items-start gap-1">
    ...
    >
{room.status?.name === 'clean' && '✅ Limpia'}
{room.status?.name === 'being cleaned' && '🧼 En limpieza'}
{room.status?.name === 'dirty' && '❌ Sucia'}
